      ...
      <div className="container">
              ...
              <div className="story-quote story-quote--second">
                <div className="quote-header quote-header--second">
                  <div className="quote-meta quote-meta--second">
                    <div className="quote-name quote-name--second">Second Person</div>
                    <div className="quote-role quote-role--second"><i>Co-Director,</i> <span>Aimerz Advisors</span></div>
                  </div>
                  <img className="quote-avatar quote-avatar--second" src="/image.png" alt="Second Person" />
                </div>
        ...
        <div className="container">
          <div className="cta-content2">
            <h2 className="cta-title2">Unlock Your Growth</h2>
            <p className="cta-subtitle2">
            ...
            <button className="why-choose-button2" onClick={handleContactClick}>
              Contact
