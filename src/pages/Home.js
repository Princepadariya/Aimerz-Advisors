        ...
        <div className="container">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <button className="cta-button">Unlock Your Growth</button>
            </div>
          ...
          <div className="why-choose-content">
            <div className="why-choose-text">
              ...
              <button className="why-choose-button">
                Learn More
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="button-arrow">
      ...
      <section className="cta-banner">
        <div className="container">
          <div className="cta-content">
            ...
            <button className="why-choose-button" onClick={handleContactClick}>
              Contact
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="button-arrow-1">
                <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
          </div>
